...
$whereClause = 'WHERE p.sellingPrice = 0';

// Set the SQL query based on the selected entity type
if ($entityType == 'category') {
    $whereClause .= ' AND c.categoryName IS NOT NULL';
...
try {
    ...
    // Fetch the total number of products with selling price = 0
    ...
    // Fetch products with selling price = 0 for the current page
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
    <h5 class="mb-1"><b>View Products with Selling Price = 0</b></h5>



    <div class="row" style="margin-left:70%;margin-top:-3.3%;box-shadow;">
        <div class="col-sm-8 offset-sm-4">
            <a href="addprice.php" class="btn btn-secondary">Add Price</a>
        </div>
    </div>
